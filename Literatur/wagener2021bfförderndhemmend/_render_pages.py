#!/usr/bin/env python3
"""Rendert die PDF-Seiten als JPEG fuer Vision-Verifikation.
Annahme: PDF[0] = Buchseite 418 (zu pruefen!)."""
import fitz, os, time, glob

PDF = 'Wagener2021bfhemmendförderndimklassenklntext S418-424.pdf'
PDF0_BUCHSEITE = 418
MAX_W = 1600
QUALITY = 75
...
doc = fitz.open(PDF)
print(f'      {doc.page_count} Seiten -> wahrscheinlich S. {PDF0_BUCHSEITE}-{PDF0_BUCHSEITE+doc.page_count-1}', flush=True)
